...
public class Pawn extends Figures {
    ...
    public ArrayList move(int x, int y, char playercolor, char[][][] board)
    {
        ArrayList possibleMoves = new ArrayList<>();
            ...
            if (playercolor == 'b') {
                ...
                if (y == 3 && board[y - 1][x].length == 0 && board[y - 2][x].length != 0)
                { //a black pawn start two space move
                    int[] figPos = {y - 2, x};
            ...
            if (playercolor == 'w')
            {
                ...
                if (y == 4 && board[y + 1][x].length == 0 && board[y + 2][x].length != 0)
                { //a white pawn start two space move
                    int[] figPos = {y + 2, x};
                    Object[] cell = {board[y + 2][x], figPos};
                    possibleMoves.add(cell);
                }
